const STORAGE_KEY = "library_books_v5";
let books = [];
...
function renderBooks() {
  ...
  filtered.forEach(book => {
    ...
    card.innerHTML = `
      ...
      <div>Status: ${book.available 
        ? "Available" 
        : `Borrowed by ${book.borrowerName} (ID: ${book.borrowerId})`}</div>
      <div class="actions">
...
// Update stats (Total, Available, Borrowed)
